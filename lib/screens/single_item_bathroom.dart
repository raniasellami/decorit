...
import 'package:pim/screens/models/data.dart';
import 'package:pim/screens/models/product_model.dart';

import 'details_screen.dart';

class SingleItemBathroom extends StatelessWidget {
  final String? title;
  const SingleItemBathroom({
    Key? key,
    this.title,
  }) : super(key: key);
  ...
  Widget _buildProducts(BuildContext context, int index) {
    ...
    ProductModel productModel = product4List[index];
